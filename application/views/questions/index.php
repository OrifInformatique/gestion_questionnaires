			...
			<div class="row">
				...
				<div class="table-responsive">
					<table class="table table-hover" id="sort-table">
						<thead>
							<tr>
								<th onclick="sortTable(0)" class="sorted_th" id="th0"><?= $this->lang->line('question'); ?></th>
								<th onclick="sortTable(1)" class="sorted_th" id="th1"><?= $this->lang->line('question_type'); ?></th>
								<th onclick="sortTable(2)" class="sorted_th" id="th2"><?= $this->lang->line('points'); ?></th>
							</tr>
						</thead>
						<tbody>
...
function displayQuestion($question)
{
	...
	<tr id="<?php echo $question->ID; ?>" >
		<td class="sorted_td" id="question"><a href="./Question/detail/<?php echo $question->ID;?>">
			<?php 
		...
		<td class="sorted_td"><?php echo $question->question_type->Type_Name ?></td>
		<td class="sorted_td" style="text-align: right;"><?php echo $question->Points; ?></td>
